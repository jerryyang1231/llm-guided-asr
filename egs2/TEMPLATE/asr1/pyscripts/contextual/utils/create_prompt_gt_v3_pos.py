...
class PromptGenerator:
    ...
    def process_all_files(self, base_path, splits=('train_sp', 'dev', 'test')):
        ...
        for split in splits:
            ...
            output_file = base_path / f"{split}/prompt_gt_context_pos.txt"
...
def main():
    ...
    # 設定各split的entity檔案路徑
    entity_files = {
        'train_sp': f"/share/nas169/yuchunliu/espnet_contextual/espnet/egs2/slidespeech/asr1_small/local/contextual/contexts/context_S95_keywords_train.txt",
        'dev': f"{entity_base_path}/dev_entities.txt",
        'test': f"/share/nas169/yuchunliu/espnet_contextual/espnet/egs2/slidespeech/asr1_small/local/contextual/contexts/context_keywords_test.txt"
    }
