...
if __name__ == '__main__':
    ...
    output_path = '/share/nas169/yuchunliu/espnet_contextual/espnet/egs2/esun/asr1/exp/asr_whisper_medium_multidescription_unrelated_finetune/ref_sents'
    write_file(output_path, [[d] for d in ref_sents], sp='')
    output_path = '/share/nas169/yuchunliu/espnet_contextual/espnet/egs2/esun/asr1/exp/asr_whisper_medium_multidescription_unrelated_finetune/hyp_sents'
    write_file(output_path, [[d] for d in hyp_sents], sp='')

    output_path = '/share/nas169/yuchunliu/espnet_contextual/espnet/egs2/esun/asr1/exp/asr_whisper_medium_multidescription_unrelated_finetune/ref_common_sents'
    write_file(output_path, [[d] for d in ref_common_sents], sp='')
    output_path = '/share/nas169/yuchunliu/espnet_contextual/espnet/egs2/esun/asr1/exp/asr_whisper_medium_multidescription_unrelated_finetune/hyp_common_sents'
    write_file(output_path, [[d] for d in hyp_common_sents], sp='')

    output_path = '/share/nas169/yuchunliu/espnet_contextual/espnet/egs2/esun/asr1/exp/asr_whisper_medium_multidescription_unrelated_finetune/ref_rareword_sents'
    write_file(output_path, [[d] for d in ref_rareword_sents], sp='')
    output_path = '/share/nas169/yuchunliu/espnet_contextual/espnet/egs2/esun/asr1/exp/asr_whisper_medium_multidescription_unrelated_finetune/hyp_rareword_sents'
    write_file(output_path, [[d] for d in hyp_rareword_sents], sp='')

    output_path = '/share/nas169/yuchunliu/espnet_contextual/espnet/egs2/esun/asr1/exp/asr_whisper_medium_multidescription_unrelated_finetune/ref_rareword_engs'
    write_file(output_path, [[d] for d in ref_rareword_engs], sp='')
    output_path = '/share/nas169/yuchunliu/espnet_contextual/espnet/egs2/esun/asr1/exp/asr_whisper_medium_multidescription_unrelated_finetune/hyp_rareword_engs'
    write_file(output_path, [[d] for d in hyp_rareword_engs], sp='')

    output_path = '/share/nas169/yuchunliu/espnet_contextual/espnet/egs2/esun/asr1/exp/asr_whisper_medium_multidescription_unrelated_finetune/ref_rareword_zhs'
    write_file(output_path, [[d] for d in ref_rareword_zhs], sp='')
    output_path = '/share/nas169/yuchunliu/espnet_contextual/espnet/egs2/esun/asr1/exp/asr_whisper_medium_multidescription_unrelated_finetune/hyp_rareword_zhs'
    write_file(output_path, [[d] for d in hyp_rareword_zhs], sp='')

    output_path = '/share/nas169/yuchunliu/espnet_contextual/espnet/egs2/esun/asr1/exp/asr_whisper_medium_multidescription_unrelated_finetune/error_pattren_asr.tsv'
