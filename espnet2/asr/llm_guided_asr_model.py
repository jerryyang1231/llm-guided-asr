...
class LLMGuidedASRModel(AbsESPnetModel):
    ...
    def __init__(
        ...
        # train_prompt_path="/share/nas169/jerryyang/espnet/egs2/esun/work/dump/raw/train_sp/prompt",
        # dev_prompt_path="/share/nas169/jerryyang/espnet/egs2/esun/work/dump/raw/dev/prompt",
        # test_prompt_path="/share/nas169/jerryyang/espnet/egs2/esun/work/dump/raw/test/prompt",
    ):
        super().__init__()
        ...
        #         for line in f:
        #             utt_id, prompt_text = line.strip().split(" ", 1)
        #             # prompt_text = prompt_text.replace("主題為:", "").replace("開始吧。", "")
        #             # tokens = [x.strip() for x in re.split(r"[，,。\s]+", prompt_text) if x.strip()]
